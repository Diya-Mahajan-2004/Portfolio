...
function Navbar() {
  ...
  return (
    <nav className="navbar flex items-center justify-between flex-wrap bg-[rgb(18,43,55)] p-5 shadow-2xl">
      ...
      <div className={`w-full lg:flex lg:items-center lg:w-auto ${isOpen ? "" : "hidden"}`}>
        <div className="text-md lg:flex-grow font-semibold">
          <NavLink href="/" text="Home" className="mr-8 hover:text-[#f975b1] hover:bg-[rgb(199,236,255)] text-[#f981b7] hover:bg-opacity-25 hover:py-1 hover:px-4 hover:rounded-lg" />
      ...
      <button className="bg-[rgb(15,38,49)] text-[#ffffca]  border-[#f981b7] border-4 py-1 px-6 rounded-md mt-0 mr-8 hover:bg-[#ffffe4] hover:text-[#012a4a]">
        Hire Me
      </button>
    </nav>
  );
...
const NavLink = ({ href, text, className }) => (
  <a href={href} className={`block lg:inline-block lg:mt-0 bg-[rgb(18,43,55)] text-[#f981b7] px-4 py-2 transition duration-300 ease-in-out ${className}`}>
    {text}
  </a>
);
